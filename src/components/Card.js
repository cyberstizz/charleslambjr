...
width: '7vw', height: '5vh', marginRight: '.5vw', color: props.backgroundColor}}>Github</button></a></div>
       ...
       <div id="cardFooter" style={{border: 'solid black 2px', position: 'relative', marginRight: '.5vw', height: '9vh', width: '22vw', backgroundColor: props.backgroundColor}}>ougoufo</div>
        </div>
        // </div>
    )
};
